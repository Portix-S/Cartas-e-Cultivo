...
public class GameController : MonoBehaviour {
    ...
    private bool canPlayerDraw = false;
    ...
    public void DrawCard() {
        ...
        { // Se houverem cartas no deck:
            ...
            {
                int freeSlotsInHand = handScript.GetMaxCards() - handScript.currentCards;
                if (freeSlotsInHand >= maxCardsToDraw)
                {
                    numOfCardsToBeBought = maxCardsToDraw;
                }
                else
                    numOfCardsToBeBought = freeSlotsInHand;
            }
            else
            {
